...
use eTraxis\CommandBus\Records\ResumeCommand;
...
class ResumeCommandHandler
{
     ...
     *
     * @param   ResumeCommand $command
     *
     * @throws  AccessDeniedHttpException
     * @throws  NotFoundHttpException
     */
    public function handle(ResumeCommand $command)
    {
        ...
        if (!$this->security->isGranted(RecordVoter::RESUME, $record)) {
